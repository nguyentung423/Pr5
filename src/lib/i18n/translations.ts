export const translations = {
  vi: {
    ...
    home: {
      ...
      credibility:
        "Sinh viên năm 3 Trường Đại học Công nghệ – Đại học Quốc gia Hà Nội, định hướng Business Analyst, tập trung vào phân tích yêu cầu và giải quyết bài toán nghiệp vụ",
      ...
      viewAll: "Xem tất cả →",
      workComingSoon: "Dự án sẽ cập nhật sớm.",

      // Analysis Notes
      analysisNotes: "Ghi chú Phân tích",
      analysisNotesDesc:
        "Ghi chép ngắn về cách đặt câu hỏi, ưu tiên yêu cầu, và trao đổi với stakeholder. Tập trung vào clarity, framing, và alignment.",
      notesComingSoon: "Ghi chú sẽ cập nhật sớm.",

      // Closing reflection
      workingTogether: "Nơi tôi ghi lại",
      workingTogetherDesc:
        "Đây là không gian tôi luyện tập tư duy BA: quan sát mơ hồ, hỏi đủ để rõ, và viết xuống để đội kỹ thuật hiểu đúng. Không phải tuyên bố năng lực, mà là hành trình học và làm cho rõ ràng.",
    ...
    footer: {
      ...
      navAbout: "Giới thiệu",
      navContact: "Liên hệ",
      contactCue: "Có gì muốn trao đổi?",
    },
    ...
    about: {
      ...
      interestsP1:
        "Tư duy hệ thống, kiến trúc thông tin, và nghệ thuật làm cho những thứ phức tạp trở nên đơn giản. Nền tảng này như một tài liệu sống — nơi ghi lại suy nghĩ và phát triển ý tưởng theo thời gian.",
      philosophyTitle: "Cách tôi làm việc",
      philosophyList: [
        {
          principle: "Rõ ràng hơn phức tạp",
          desc: "Nếu không thể giải thích đơn giản, nghĩa là chưa hiểu đủ sâu.",
        },
        {
          principle: "Chiều sâu hơn chiều rộng",
          desc: "Một vấn đề được giải quyết triệt để tốt hơn mười vấn đề được xử lý qua loa.",
        },
        {
          principle: "Tiến bộ hơn hoàn hảo",
          desc: "Làm xong, rồi làm tốt hơn.",
        },
        {
          principle: "Tư duy dài hạn",
      ...
      experienceItems: [
        {
          headline: "Nghiên cứu để hỗ trợ quyết định chiến lược",
          detail:
            "Phân tích thị trường và xu hướng, cung cấp cơ sở dữ liệu cho các lựa chọn kinh doanh.",
        },
        {
          headline: "Khám phá và xác nhận ý tưởng sản phẩm",
          detail:
            "Tham gia giai đoạn đầu trong môi trường incubator, tập trung vào việc hiểu vấn đề trước khi xây dựng.",
        },
        {
          headline: "Hiểu 'tại sao' trước khi đề xuất 'làm gì'",
          detail:
            "Phân tích hành vi người dùng và dữ liệu hiệu suất để đề xuất cải tiến có căn cứ.",
        },
        {
          headline: "Hướng dẫn tư duy có cấu trúc",
          detail:
            "Mentor sinh viên STEM, khuyến khích phân tích vấn đề trước khi tìm giải pháp.",
        },
      ],
      certificatesToggle: "Xem học tập & nền tảng",
      certificatesItems: [
        {
          headline: "Nền tảng về tư duy chiến lược",
          detail:
            "Học thuật về Quản trị Chiến lược, kết hợp tự học về phân tích nghiệp vụ.",
        },
        {
          headline: "Quan tâm đến cách hệ thống vận hành",
          detail:
            "Cách các bên liên quan ra quyết định, và cách làm rõ những điều mơ hồ.",
        },
      ],
      activitiesToggle: "Xem hoạt động & ghi nhận",
      activitiesItems: [
        {
          headline: "Thực hành phân tích trong môi trường thi đấu",
          detail:
            "Các cuộc thi kinh doanh và khởi nghiệp đòi hỏi xác định giả định và trình bày giải pháp có cấu trúc.",
        },
        {
          headline: "Ghi nhận vì cách tiếp cận vấn đề",
          detail:
            "UEB Business Challenge, Innovative Tech Idea, Startup Launchpad — không phải vì kết quả.",
        },
        {
          headline: "Rèn luyện ra quyết định trong mơ hồ",
          detail:
            "Học cách làm việc khi thông tin chưa đầy đủ và yêu cầu chưa rõ ràng.",
        },
      ],
    },
  ...
  en: {
    ...
    home: {
      ...
      caseStudies: "Case Studies",
      viewAll: "View all →",
      workComingSoon: "Work coming soon.",
    ...
    about: {
      ...
      interestsP1:
        "Systems thinking, information architecture, and the craft of making complex things simple. This platform serves as a living document — a place to document thinking and evolve ideas over time.",
      ...
      philosophyList: [
        ...
        },
        {
          ...
          desc: "One problem solved thoroughly beats ten problems addressed superficially.",
        },
        {
          principle: "Progress over perfection",
          desc: "Ship it, then make it better.",
        },
        {
      ...
      experienceItems: [
        {
          headline: "Research to support strategic decisions",
          detail:
            "Analyzed market trends and data to provide basis for business choices.",
        },
        {
          headline: "Early-stage product exploration",
          detail:
            "Participated in incubator environment, focusing on understanding problems before building.",
        },
        {
          headline: "Understanding 'why' before suggesting 'what'",
          detail:
            "Analyzed user behavior and performance data to propose evidence-based improvements.",
        },
        {
          headline: "Facilitating structured thinking",
          detail:
            "Mentored STEM students, encouraging problem analysis before solution-finding.",
        },
      ],
      certificatesToggle: "View learning & foundation",
      certificatesItems: [
        {
          headline: "Foundation in strategic thinking",
          detail:
            "Academic background in Strategic Management, combined with self-study in business analysis.",
        },
        {
          headline: "Interest in how systems work",
          detail:
            "How stakeholders make decisions, and how to bring clarity to ambiguity.",
        },
      ],
      activitiesToggle: "View activities & recognition",
      activitiesItems: [
        {
          headline: "Practicing analysis in competitive settings",
          detail:
            "Business and startup competitions requiring assumption identification and structured solution presentation.",
        },
        {
          headline: "Recognized for problem approach",
          detail:
            "UEB Business Challenge, Innovative Tech Idea, Startup Launchpad — not for results.",
        },
        {
          headline: "Learning to decide in ambiguity",
          detail:
            "Working with incomplete information and unclear requirements.",
        },
      ],
    },
...
// Use a more flexible type that accepts either language's structure
